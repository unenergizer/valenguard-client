 ...
 * Original File Date: 1/18/2018 @ 7:19 AM
...
public class FileManager {
    ...
    public float loadCompleted() { return assetManager.getProgress(); }
    ...
    public void loadTiledMap(GameMap gameMap) {
        ...
        if (isFileLoaded(gameMap.getFilePath())) {
            Gdx.app.debug(TAG, "Map already loaded: " + gameMap.getFilePath());
            return;
        }
        ...
        if (filePathResolver.resolve(gameMap.getFilePath()).exists()) {
            ...
            Gdx.app.debug(TAG, "Map doesn't exist: " + gameMap.getFilePath());
        }
    }
